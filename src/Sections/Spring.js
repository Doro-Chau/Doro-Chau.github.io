export function springyEmojiCursor(options) {
    ...
    function init() {
      ...
      bgContext.font = "24px serif";
      bgContext.textBaseline = "middle";
      bgContext.fillStyle = '#741734';
      bgContext.fillText(
        '●',
        bgCanvas.width / 2,
      ...
      let bgCanvas2 = document.createElement("canvas");
      let bgContext2 = bgCanvas2.getContext("2d");
  
      bgCanvas2.width = measurements.width;
      bgCanvas2.height = measurements.actualBoundingBoxAscent * 2;
  
      bgContext2.textAlign = "center";
      bgContext2.font = "24px serif";
      bgContext2.textBaseline = "middle";
      bgContext2.fillStyle = '#129490';
      bgContext2.fillText(
        '●',
        bgCanvas2.width / 2,
        measurements.actualBoundingBoxAscent
      ...
      let bgCanvas3 = document.createElement("canvas");
      let bgContext3 = bgCanvas3.getContext("2d");

      bgCanvas3.width = measurements.width;
      bgCanvas3.height = measurements.actualBoundingBoxAscent * 2;
  
      bgContext3.textAlign = "center";
      bgContext3.font = "24px serif";
      bgContext3.textBaseline = "middle";
      bgContext3.fillStyle = '#EF798A';
      bgContext3.fillText(
        '●',
        bgCanvas3.width / 2,
        measurements.actualBoundingBoxAscent
      ...
      let bgCanvas4 = document.createElement("canvas");
      let bgContext4 = bgCanvas4.getContext("2d");

      bgCanvas4.width = measurements.width;
      bgCanvas4.height = measurements.actualBoundingBoxAscent * 2;
  
      bgContext4.textAlign = "center";
      bgContext4.font = "24px serif";
      bgContext4.textBaseline = "middle";
      bgContext4.fillStyle = '#DE9151';
      bgContext4.fillText(
        '●',
        bgCanvas4.width / 2,
        measurements.actualBoundingBoxAscent
      ...
      let emojiAsImage2 = bgCanvas2;
      let emojiAsImage3 = bgCanvas3;
      let emojiAsImage4 = bgCanvas4;
      ...
      for (i = 0; i < nDots; i++) {
        if (i % 4 === 0) {
            ...
            particles[i] = new Particle(emojiAsImage2);
            continue
        } else if (i % 4 === 2) {
            particles[i] = new Particle(emojiAsImage4);
            continue
        }
        particles[i] = new Particle(emojiAsImage3);
      }
